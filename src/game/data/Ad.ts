...
class Ad {
    ...
    public static video: string = "b5c7khjfj23fi586db"; // "18uirlsxvgd19j4ky9"; //体力不足激励视频
    // public static videoTip: string = "4ihfo5gui520550an6"; //关卡提示按钮激励视频

    public static loadingBanner: string = "1egocloqu91nj7h52i"; // "2ec1gm57ng77j4lq6d";  //loading页面banner
