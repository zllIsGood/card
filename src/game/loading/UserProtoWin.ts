 ...
 * @Last Modified time: 2020-10-27 17:49:12
 */
class UserProtoWin extends BaseEuiView {
    ...
    /*getxy() {
        if (this.xy0 == null) {
            ...
            lab1.size = 24
            lab1.text = '请务必仔细阅读、理解“服务协议”和“隐私政策”各项条款。包括但不限于IP地址、读取个人通讯录等个人信息您可以在“设置”中查看、变更、删除个人信息并管理您的授权信息。您可阅读'
            let w = lab1.width
            lab1.text = '《服务协议》'
            let w0 = lab1.width
            ...
            lab1.text = '请务必仔细阅读、理解“服务协议”和“隐私政策”各项条款。包括但不限于IP地址、读取个人通讯录等个人信息您可以在“设置”中查看、变更、删除个人信息并管理您的授权信息。您可阅读《服务协议》和'
            w = lab1.width
            lab1.text = '《隐私政策》'
            w0 = lab1.width
    ...
    upView() {
        let str = `请务必仔细阅读、理解“服务协议”和“隐私政策”各项条款。包括但不限于IP地址、读取个人通讯录等个人信息您可以在“设置”中查看、变更、删除个人信息并管理您的授权信息。您可阅读<font color = '#25D1E0'>《服务协议》</font>和<font color = '#25D1E0'>《隐私政策》</font>了解详细信息。若您同意，请点击“同意”开始接受我们的服务。`
