class DragonBonesArmature extends egret.DisplayObjectContainer {
    ...
    private addListeners(): void {
        this._armature.eventDispatcher.addDBEventListener(dragonBones.EventObject.COMPLETE, this.completeHandler, this);
        this._armature.eventDispatcher.addDBEventListener(dragonBones.EventObject.FRAME_EVENT, this.frameHandler, this);
    }
    ...
    private removeListeners(): void {
        this._armature.eventDispatcher.removeDBEventListener(dragonBones.EventObject.COMPLETE, this.completeHandler, this);
        this._armature.eventDispatcher.removeDBEventListener(dragonBones.EventObject.FRAME_EVENT, this.frameHandler, this);
    }
